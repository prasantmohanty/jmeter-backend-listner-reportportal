...
public class LaunchImportRq {
  ...
  public LaunchImportRq setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public LaunchImportRq setDescription(String description) {
  ...
  public LaunchImportRq setMode(String mode) {
    this.mode = mode;
    return this;
  }
  ...
  public LaunchImportRq setStartTime(Instant startTime) {
  ...
  public LaunchImportRq setAttributes(List<Attribute> attributes) {
