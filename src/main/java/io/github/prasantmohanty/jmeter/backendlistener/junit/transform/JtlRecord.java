...
public class JtlRecord {
  ...
  public boolean equals(Object o) {
    ...
    if (responseMessage != null
        ? !responseMessage.equals(jtlRecord.responseMessage)
        : jtlRecord.responseMessage != null) return false;
    if (failureMessage != null
        ? !failureMessage.equals(jtlRecord.failureMessage)
        : jtlRecord.failureMessage != null) return false;
    if (requestHeaders != null
        ? !requestHeaders.equals(jtlRecord.requestHeaders)
        : jtlRecord.requestHeaders != null) return false;
    if (requestBody != null
        ? !requestBody.equals(jtlRecord.requestBody)
        : jtlRecord.requestBody != null) return false;
    if (responseHeaders != null
        ? !responseHeaders.equals(jtlRecord.responseHeaders)
        : jtlRecord.responseHeaders != null) return false;
    if (responseBody != null
        ? !responseBody.equals(jtlRecord.responseBody)
        : jtlRecord.responseBody != null) return false;
    return !(responseCode != null
        ? !responseCode.equals(jtlRecord.responseCode)
        : jtlRecord.responseCode != null);
  }
